...
# Use default database configuration (no need to source .env for CodeIgniter)
# CodeIgniter uses config/app.env for database configuration

# Set default database variables for CodeIgniter
DB_HOST="127.0.0.1"
DB_PORT="3308"
DB_USERNAME="root"
DB_PASSWORD="rootpassword"
DB_DATABASE="codeigniter_app_db"
...
POSTGRES_DATABASE="codeigniter_app_db"
