...
read_legacy_values() {
    ...
    values[REDIS_PORT]="6380"
    values[MYSQL_DATABASE]="simple_php_db"
    values[POSTGRES_DATABASE]="simple_php_db"
...
# =============================================================================
APACHE_APP_DIR="${values[APACHE_APP_DIR]:-/var/www/simple-php}"
...
create_default_config() {
    ...
    default_values[APP_PORT]="8000"
    default_values[NETWORK_INTERFACE]="127.0.0.1"
    default_values[PHP_VERSION]="8.4"
    default_values[DEPLOYMENT_TYPE]="php-cli"
    default_values[MYSQL_PORT]="3307"
    default_values[POSTGRES_PORT]="5433"
    default_values[REDIS_PORT]="6380"
    default_values[MYSQL_DATABASE]="simple_php_db"
    default_values[POSTGRES_DATABASE]="simple_php_db"
