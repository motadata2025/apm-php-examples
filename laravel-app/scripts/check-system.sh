...
# Laravel Application - System Requirements Check
...
# Function to check Laravel requirements
check_laravel_requirements() {
    echo -e "\n${PURPLE}🎨 Checking Laravel Requirements...${NC}"
    ...
    local required_extensions=("openssl" "pdo" "mbstring" "tokenizer" "xml" "ctype" "json" "bcmath")
